...
#pragma mark -- 获取窗体‘宽度’
const GLuint RenderView::getSCRWidth()
{
...
#pragma mark -- 获取窗体‘高度’
const GLuint RenderView::getSCRHeight()
{
...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    while (!glfwWindowShouldClose(this->window))
    {
        ...
        // 设定‘观察’矩阵的值
        customShader.setTrans("viewMat", glm::value_ptr(viewMat));
        
        // 设定‘投影’矩阵的值
        customShader.setTrans("projectionMat", glm::value_ptr(projectionMat));
