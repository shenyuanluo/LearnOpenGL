...
void Window::render()
{
    ...
    /* 创建'法线'着色器 */
    Shader normalVisualShader(fullPath("NormalVisualVS.glsl").c_str(), fullPath("NormalVisualGS.glsl").c_str(), fullPath("NormalVisualFS.glsl").c_str());
    /* ‘战士’模型加载 */
    ...
    while (!glfwWindowShouldClose(m_window))
    {
        ...
        /* ========== 绘制法线 ========== */
        normalVisualShader.setUniformMat4("modelMat", modelMat.use());
        /* 用摄像机设置观察矩阵 */
        normalVisualShader.setUniformMat4("viewMat", g_camera.use());
        /* 设置投影矩阵 */
        normalVisualShader.setUniformMat4("projectionMat", projectionMat.use());
        nanosuitModel.draw(normalVisualShader);
