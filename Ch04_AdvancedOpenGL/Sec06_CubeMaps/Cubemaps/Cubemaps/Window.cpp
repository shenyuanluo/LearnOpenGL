...
void Window::render()
{
    ...
    cubeShader.setUniformInt("cubeSampler", 0);
    cubeShader.setUniformInt("emojiSampler", 1);
    /* 箱子纹理 */
    Texture cubeTexture(fullPath("../../../../Resources/TextureImage/container.jpg").c_str());
    Texture emojiTexture(fullPath("../../../../Resources/TextureImage/awesomeface.png").c_str());
...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    while (!glfwWindowShouldClose(m_window))
    {
        ...
        emojiTexture.use2D(GL_TEXTURE1);
        glBindVertexArray(cubeVAO);
