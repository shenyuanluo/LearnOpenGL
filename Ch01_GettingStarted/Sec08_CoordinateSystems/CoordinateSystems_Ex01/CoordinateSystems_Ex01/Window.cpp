...
void Window::render(GLfloat* vertexBuff, GLuint buffLen)
{
    ...
    /* 创建纹理 对象1 */
    Texture texture1("../../../../Resources/TextureImage/container.jpg", GL_RGB, GL_RGB);
    /* 创建纹理 对象2 */
    Texture texture2("../../../../Resources/TextureImage/awesomeface.png", GL_RGBA, GL_RGBA);
    ...
    while (!glfwWindowShouldClose(m_window))
    {
        ...
        /* 使用纹理 */
        texture1.use2D(GL_TEXTURE0);
        
        /* 使用纹理 */
        texture2.use2D(GL_TEXTURE1);
        ...
        /* 设置模型矩阵 */
        Transform modelMat;
        modelMat.rotate((GLfloat)timeValue, 0.5f, 1.0f, 0.0f);
        shader.setUniformMat4("modelMat", modelMat.use());
        
        /* 设置观察矩阵 */
        Transform viewMat;
        viewMat.translate(0.0f, 0.0f, -3.0f);
        shader.setUniformMat4("viewMat", viewMat.use());
        
        /* 设置投影矩阵 */
        Transform projectionMat;
        projectionMat.perspective(projectionMat.radianWithDegree(45.0f), (GLfloat)m_width, (GLfloat)m_height, 0.01, 100.0f);
