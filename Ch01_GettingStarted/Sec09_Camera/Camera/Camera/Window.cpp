...
void Window::render(GLfloat* vertexBuff, GLuint buffLen)
{
    ...
    /* 创建纹理 对象1 */
    Texture texture1(fullPath("../../../../Resources/TextureImage/container.jpg").c_str(), GL_RGB, GL_RGB);
    /* 创建纹理 对象2 */
    Texture texture2(fullPath("../../../../Resources/TextureImage/awesomeface.png").c_str(), GL_RGBA, GL_RGBA);
