...
void main()
{
    ...
    FragPos  = vec3(viewMat * modelMat * vec4(aPos, 1.0)); /* 把片段位置从世界空间坐标 转到 观察空间坐标 */
    LightPos = vec3(viewMat * vec4(lightPos, 1.0f));    /* 把光源位置向量从世界空间坐标 转到 观察空间坐标 */
