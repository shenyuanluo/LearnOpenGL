...
void Window::render(GLfloat* vertexBuff, GLuint buffLen)
{
    ...
    /* ================ 设置材质属性 ================ */
    /* 材质颜色·环境光照 */
    objectShader.setUniformVec3("material.ambient",  1.0f, 0.5f, 0.31f);
    /* 材质颜色·漫反射光照 */
    objectShader.setUniformVec3("material.diffuse",  1.0f, 0.5f, 0.31f);
    /* 材质颜色·镜面光照 */
    objectShader.setUniformVec3("material.specular", 0.5f, 0.5f, 0.5f);
    /* 反光度 */
    ...
    while (!glfwWindowShouldClose(m_window))
    {
        ...
        /* ================ 更新光照属性 ================ */
        lightColor.x = sin(m_currFTime * 2.0f);
        lightColor.y = sin(m_currFTime * 0.7f);
        lightColor.z = sin(m_currFTime * 1.3f);
        
        glm::vec3 diffuseColor = lightColor   * glm::vec3(0.5f); /* 降低影响 */
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f); /* 很低的影响 */
        
        /* 环境光照·强度 */
        objectShader.setUniformVec3("light.ambient",  ambientColor);
        /* 漫反射光照·强度 */
        objectShader.setUniformVec3("light.diffuse",  diffuseColor);
