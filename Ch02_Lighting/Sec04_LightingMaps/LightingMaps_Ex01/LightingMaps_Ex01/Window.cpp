...
void Window::render(GLfloat* vertexBuff, GLuint buffLen)
{
    ...
    while (!glfwWindowShouldClose(m_window))
    {
        ...
        /* ================ 更新光照属性 ================ */
        /* 环境光照·强度 */
//        objectShader.setUniformVec3("light.ambient",  sin(m_currFTime), sin(m_currFTime), sin(m_currFTime));
        /* 漫反射光照·强度（将光照调暗了一些以搭配场景） */
//        objectShader.setUniformVec3("light.diffuse",  sin(m_currFTime), sin(m_currFTime), sin(m_currFTime));
        /* 镜面光照·强度 */
        objectShader.setUniformVec3("light.specular", sin(m_currFTime), sin(m_currFTime), sin(m_currFTime));
